...
import com.DKB.Rest.Examples.RestExamples.users.UserNotFoundException;

@ControllerAdvice
public class CustomizeResponsentityExceptionHandler extends  ResponseEntityExceptionHandler{
